...
export class PasteProxy {
    srcCellRange: CellRangeProxy
    dstCellRange: CellRangeProxy
    srcOneDRange: CellRangeProxy
    dstOneDRange: CellRangeProxy
    constructor() {
        this.srcCellRange = "";
        this.dstCellRange = "";
        this.srcOneDRange = "";
    ...
    use() {
        ...
        const [rn, cn] = this.srcCellRange.getRowColCount();
        const [drn, dcn] = this.dstCellRange.getRowColCount();
    ...
    getOneDRangeObj(way, offset) {
        ...
        if (!way) {
            this.srcOneDRange = new CellRangeProxy(sri, sci + offset, eri, sci + offset);
            this.dstOneDRange = new CellRangeProxy(dsri, dsci + offset, deri, dsci + offset);
        } else {
            this.srcOneDRange = new CellRangeProxy(sri + offset, sci, sri + offset, eci);
            this.dstOneDRange = new CellRangeProxy(dsri + offset, dsci, dsri + offset, deci);
        }
