"use strict";
import {RawValue} from '../calc_data_proxy/exp_raw_value.js'
import {SUnitRangeRef} from '../calc_data_proxy/exp_range_value.js'
import {SUnitRefValue} from '../calc_data_proxy/exp_ref_value.js'
import { ColIndexProxy } from '../calc_data_proxy/parser_col_index';
...
export function raw_offset(cell_ref, rows, columns, height, width) {
    ...
    if (cell_ref.args.length === 1 && cell_ref.args[0] instanceof SUnitRefValue) {
        ...
        let parsed_ref = ref_value.updateRefCalcCell();
