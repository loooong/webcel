...
export function debugout() {
    ...
    self.useTimestamps = false; // changeInsertRowOrCol a timestamp in front of applyEveryRiCi log
    self.useLocalStorage = true; // store the output using window.localStorage() and continuously add to the same log applyEveryRiCi session
